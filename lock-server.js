...
const replacement=`function sendApp(req,res){
 fs.readFile(path.join(__dirname,'public','index.html'),'utf8',(err,html)=>{
  ...
  const assets='<link rel="stylesheet" href="/lock-mode.css?v=nav-final-1"><link rel="stylesheet" href="/final-fixes.css?v=nav-final-1"><script defer src="/lock-mode.js?v=nav-final-1"></script><script defer src="/final-fixes.js?v=nav-final-1"></script><script defer src="/lock-polish.js?v=nav-final-1"></script><script defer src="/home-nav-polish.js?v=nav-final-1"></script><script defer src="/home-auth-guard.js?v=nav-final-1"></script><script defer src="/game-flow-polish.js?v=nav-final-1"></script><script defer src="/lock-button-pin.js?v=nav-final-1"></script><script defer src="/asshole-return-polish.js?v=nav-final-1"></script><script defer src="/asshole-beer-stats.js?v=nav-final-1"></script><script defer src="/asshole-lock-final.js?v=nav-final-1"></script><script defer src="/nav-popup-final.js?v=nav-final-1"></script>';
